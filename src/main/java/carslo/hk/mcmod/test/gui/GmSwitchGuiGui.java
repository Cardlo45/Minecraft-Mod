...
public class GmSwitchGuiGui extends Hk400testModElements.ModElement {
	...
	public GmSwitchGuiGui(Hk400testModElements instance) {
		super(instance, 22);
		...
		if (buttonID == 0) {
			{
				...
				GmSurvivalProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				GmCreativeProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				GmAdventureProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 3) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				GmSpectatorProcedure.executeProcedure($_dependencies);
			}
		}
	}
