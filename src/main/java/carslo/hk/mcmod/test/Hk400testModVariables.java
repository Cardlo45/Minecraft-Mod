...
public class Hk400testModVariables {
	public Hk400testModVariables(Hk400testModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("hk400test", "player_variables"), new PlayerVariablesProvider());
	}
